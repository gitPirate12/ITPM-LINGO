  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get(
        `http://localhost:3040/emoji/search/${encodeURIComponent(emoji)}`
      );
  ...
  return (
    <div className="emoji-container">
      <div className="emoji-header">
        <h2>Emoji to Text Translator</h2>
      </div>
      <div className="emoji-body">
        ...
        <div className="meanings-container">
          <div className="meaning-box">
            <div className="meaning-heading-eng">English</div>
            <div className="meaning-content">{meaningEng}</div>
          </div>
          <div className="meaning-box">
            <div className="meaning-heading-sin">සිංහල</div>
